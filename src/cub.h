...
/*   Updated: 2023/11/05 23:12:49 by ffilipe-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				cpy_img_to_frame_buffer(t_image *dst, t_image src, int x,
						int y);
...
float				get_next_player_x_pos(t_cub *cub,
						enum e_direction direction);
float				get_next_player_y_pos(t_cub *cub,
						enum e_direction direction);
